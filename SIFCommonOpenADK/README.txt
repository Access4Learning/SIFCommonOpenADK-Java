...
an easy to use API on top of the OpenADK.  It adds further functionality behind the scene such as interfaces 
...
==============================
From the command-line type: git clone git://github.com/nsip/SIFCommonOpenADK-Java.git
